                      ...
                      return (
                        ...
                        >
                          <div className="flex h-full items-center justify-between gap-4">
                            <div className="min-w-0 flex-1">
                              <p className="text-sm font-medium text-[#3d1a0d]">
                                {option.name}
                              </p>
                              <p className="mt-2 text-xs leading-relaxed text-gray-500 md:whitespace-nowrap">
                                {option.description}
                              </p>
                            </div>
                            <span
                              className={`flex min-w-[92px] shrink-0 items-center justify-center whitespace-nowrap rounded-full px-3 py-2 text-xs ${
                                checked
                                  ? "bg-[#6b3a2a] text-white"
